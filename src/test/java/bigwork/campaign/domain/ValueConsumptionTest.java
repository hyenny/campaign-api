...
class ValueConsumptionTest {
    ...
    void 제목_NULL_체크() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            ValueConsumption valueConsumption = ValueConsumption.builder()
                    ...
                    .campaignService(new CampaignService(CampaignType.VALUE_CONSUMPTION))
                    .build();
        });

        assertEquals("제목이 없습니다.", exception.getMessage());
    }
    ...
    void 상세이미지_NULL_체크() {
        ...
        assertEquals("상세 이미지가 없습니다.", exception.getMessage());
    }
    ...
    void 유의사항_NULL_체크() {
        ...
        assertEquals("유의사항이 없습니다.", exception.getMessage());
    }
